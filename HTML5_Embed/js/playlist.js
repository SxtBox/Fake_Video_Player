var PLAYER = PLAYER || {};
PLAYER.Playlist = function(e, i, t, o, a, l, s, d, n, p, r, v, y, m, h, u) {
    function _() {
    ...
    function V() {
        b.vimeoIframe = e(b.vimeoWrapper).find("#" + b.options.instanceName), b.vimeoPlayer = $f(b.vimeoIframe[0]), b.vimeoStatus = e(".status"), b.vimeoPlayer.addEvent("ready", function() {
            b.vimeoPlayer.addEvent("pause", _), b.vimeoPlayer.addEvent("finish", c), b.vimeoPlayer.addEvent("playProgress", I), b.vimeoPlayer.addEvent("volumechange", D), v && "AD 5 sec + Pieces After Effects project" != b.options.videos[0].title && "Pieces After Effects project" != b.options.videos[0].title && "AD 5 sec + Space Odyssey After Effects Project" != b.options.videos[0].title && "AD 5 sec Swimwear Spring Summer" != b.options.videos[0].title && "i Create" != b.options.videos[0].title && "Swimwear Spring Summer" != b.options.videos[0].title && "PLxKkYph0URW7m7cMaHq9Df1sjNF38huut" != b.options.youtubePlaylistID && "Google drive video example" != b.options.videos[0].title && "Dropbox video example" != b.options.videos[0].title && "Livestream HLS m3u8 video example" != b.options.videos[0].title && "Openload video example" != b.options.videos[0].title && "Youtube 360 VR video" != b.options.videos[0].title && "Subtitles video example" != b.options.videos[0].title && "Live YouTube" != b.options.videos[0].title && "HTML5 Live video thumbnails" != b.options.videos[0].title && "HTML5 vtt video thumbnails" != b.options.videos[0].title && (b.VIDEO.pw(), b.vimeoWrapper.css({
                zIndex: 0
            }), e("iframe#" + b.options.instanceName).attr("src", ""))
        })
    }
    var b = this;
    switch (this.VIDEO = i, this.element = a, this.youtube_array = h, "" == t.youtubePlaylistID && "" == t.youtubeChannelID || (t.videos = b.youtube_array), this.canPlay = n, this.CLICK_EV = p, this.params = r, this.isMobile = u, this.preloader = l, this.preloaderAD = s, this.options = t, this.mainContainer = o, this.videoid = "VIDEOID", this.adStartTime = "ADSTARTTIME", this.videoAdPlayed = !1, this.rand = Math.floor(Math.random() * t.videos.length + 0), this.ytQuality = t.youtubeQuality, this.youtubeSTARTED = !1, this.deviceAgent = y, this.agentID = m, this.YTAPI_onPlayerReady = !1, this.vimeo_time, this.vimeo_duration, this.scrollingIsOn = !1, this.touchmove = !1, this.playlist = e("<div />"), this.playlistContent = e("<div />"), this.playlistContentOverlay = e("<div />").addClass("player_playlistContentOverlay").hide(), this.playlistBar = e("<div />"), this.playlistBar.addClass("player_bg player_player_" + this.options.instanceTheme), this.playlist.append(this.playlistBar), this.playlist.append(this.playlistContentOverlay), this.playlistBarInside = e("<div />"), this.playlistBarInside.addClass("player_playlistBarInside"), this.playlistBar.append(this.playlistBarInside), this.lastBtnIcon = e("<span />").attr("aria-hidden", "true").addClass("fa-player").addClass("general-player-icon").addClass("player_controlsColor player_" + this.options.instanceTheme).addClass("fa-player-step-forward").attr("id", "player_lastBtn"), this.firstBtnIcon = e("<span />").attr("aria-hidden", "true").addClass("fa-player").addClass("general-player-icon").addClass("player_controlsColor player_" + this.options.instanceTheme).addClass("fa-player-step-backward").attr("id", "player_firstBtn"), this.nextBtnIcon = e("<span />").attr("aria-hidden", "true").addClass("fa-player").addClass("general-player-icon").addClass("player_controlsColor player_" + this.options.instanceTheme).addClass("fa-player-forward").attr("id", "player_nextBtn"), this.previousBtnIcon = e("<span />").attr("aria-hidden", "true").addClass("fa-player").addClass("general-player-icon").addClass("player_controlsColor player_" + this.options.instanceTheme).addClass("fa-player-backward").attr("id", "player_previousBtn"), this.shuffleBtnIcon = e("<span />").attr("aria-hidden", "true").attr("id", "player_shuffleBtn").addClass("fa-player").addClass("general-player-icon").addClass("player_controlsColor player_" + this.options.instanceTheme).addClass("fa-player-random").addClass("video_playerElement"), this.lastBtn = e("<div />").addClass("player_playlistBarBtn").addClass("video_playerElement"), this.lastBtn.append(this.lastBtnIcon), this.firstBtn = e("<div />").addClass("player_playlistBarBtn").addClass("video_playerElement"), this.firstBtn.append(this.firstBtnIcon), this.nextBtn = e("<div />").addClass("player_playlistBarBtn").addClass("video_playerElement"), this.nextBtn.append(this.nextBtnIcon), this.previousBtn = e("<div />").addClass("player_playlistBarBtn").addClass("video_playerElement"), this.previousBtn.append(this.previousBtnIcon), this.shuffleBtn = e("<div />").addClass("player_playlistBarBtn").addClass("video_playerElement"), this.shuffleBtn.append(this.shuffleBtnIcon), this.playlistBarInside.append(this.firstBtn), this.playlistBarInside.append(this.previousBtn), this.playlistBarInside.append(this.shuffleBtn), this.playlistBarInside.append(this.nextBtn), this.playlistBarInside.append(this.lastBtn), this.options.playlist) {
        case "Right playlist":
            this.playlist.attr("id", "player_playlist"), this.playlist.addClass("player_playlist player_" + this.options.instanceTheme), this.playlistContent.attr("id", b.options.instanceName + "player_playlistContent"), this.playlistBar.addClass("player_playlistBar");
            break;
        case "Bottom playlist":
            this.playlist.attr("id", "player_playlist_bottom"), this.playlist.addClass("player_playlist player_" + this.options.instanceTheme), this.playlistContent.attr("id", b.options.instanceName + "player_playlistContent_bottom"), this.playlistBar.addClass("player_playlistBar_bottom")
    }
    b.videos_array = new Array, b.item_array = new Array, this.vimeoWrapper = e("<div></div>"), this.vimeoWrapper.attr("id", "player_vimeoWrapper"), b.element && b.element.append(b.vimeoWrapper), e(this.vimeoWrapper).html('<iframe id="' + b.options.instanceName + '" src="" width="100%" height="100%" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');
    var E = 0,
        f = 0;
    this.onPlayerReady = function() {
        ...
        b.VIDEO.calculateYoutubeTotalTime(b.VIDEO.youtubePlayer.getDuration()), b.VIDEO.youtubePlayer.getDuration() > 1200 && -1 === e.data && b.VIDEO.youtubePlayer.seekTo(0), b.VIDEO.resizeVideoTrack(), 1 === e.data && 0 == o && (b.youtubeSTARTED = !0), 1 === e.data ? (b.isMobile.any() && b.VIDEO.playButtonScreen.addClass("player_playButtonScreenHide"), a.removeClass("vp_paused"), a.addClass("player_playing"), i.change("player_playing"), b.VIDEO.play(), b._timer = setInterval(function() {
            if ("HTML5" != t.videos[b.videoid].videoType && "HTML5 (self-hosted)" != t.videoType) {
    ...
    if (e(t.videos).each(function() {
            ...
            if (i.title = i.title || "", i.info_text = i.info_text || "", i.description = i.description || "", i.thumbnail_image = i.thumbnail_image || "", b.videos_array.push(i), b.nowPlayingThumbnail = e("<div />"), b.nowPlayingThumbnail.addClass("player_nowPlayingThumbnail"), b.options.playlistShowOnlyThumbnails && b.nowPlayingThumbnail.addClass("player_onlyThumbnails"), b.nowPlayingThumbnail.text(b.options.nowPlayingTooltipTxt), b.nowPlayingThumbnail.hide(), b.itemLeft = e("<div />"), b.itemLeft.addClass("player_itemLeft"), b.options.playlistShowOnlyThumbnails && b.itemLeft.addClass("player_onlyThumbnails"), b.i = document.createElement("img"), b.i.onload = function() {
                    b.thumbImageW = this.width, b.thumbImageH = this.height
                }, b.i.src = i.thumbnail_image, "youtube" != t.videos[O].videoType && "YouTube" != t.videoType || "auto" != i.thumbnail_image && "" != i.thumbnail_image && "undefined" != i.thumbnail_image || (b.options.playlistShowOnlyThumbnails ? b.i.src = "https://i.ytimg.com/vi/" + t.videos[O].youtubeID + "/mqdefault.jpg" : b.i.src = "http://img.youtube.com/vi/" + t.videos[O].youtubeID + "/1.jpg"), b.itemLeft.append(b.i), b.itemLeft.append(b.nowPlayingThumbnail), e(b.i).addClass("player_thumbnail_image player_themeColorThumbBorder"), !b.options.playlistShowOnlyThumbnails) var o = '<div class="player_itemRight"><div class="player_title player_themeColorText">' + i.title + '</div><div class="player_description player_controlsColor player_' + b.options.instanceTheme + '"> ' + i.description + "</div></div>",
                a = '<div class="player_itemRight_bottom"><div class="player_title player_themeColorText">' + i.title + '</div><div class="player_description player_controlsColor player_' + b.options.instanceTheme + '"> ' + i.description + "</div></div>";
            switch (t.playlist) {
                case "Right playlist":
                    b.item = e("<div />"), b.item.addClass("player_item").css("top", String(f) + "px"), b.item_array.push(b.item), b.item.addClass("player_itemUnselected player_" + b.options.instanceTheme), b.item.append(b.itemLeft), b.item.append(o), f += b.options.playlistShowOnlyThumbnails ? 153 : 80;
                    break;
                case "Bottom playlist":
                    b.item = e("<div />"), b.item.addClass("player_item").css("left", String(E) + "px"), b.item_array.push(b.item), b.item.addClass("player_itemUnselected_bottom player_" + b.options.instanceTheme), b.item.css("display", "inline-flex"), b.item.append(b.itemLeft), b.item.append(a)
            }
            b.options.playlistOrder = b.options.playlistOrder.toString(), "" != b.options.playlistOrder && "undefined" != b.options.playlistOrder || b.playlistContent.append(b.item), b.options.playlistShowOnlyThumbnails && e(b.item_array[O]).addClass("player_onlyThumbnails"), "Right playlist" != b.options.playlist && "Bottom playlist" != b.options.playlist || ("" == i.thumbnail_image || "thumbImg" == i.thumbnail_image || "undefined" == i.thumbnail_image ? (b.itemLeft.hide(), b.item.find(".player_itemRight").css({
                left: 7,
                paddingTop: 7,
                width: "240"
            }), "" == i.title) : "" === i.thumbnail_image && "thumbImg" === i.thumbnail_image && "undefined" === i.thumbnail_image || (b.itemLeft.show(), b.item.find(".player_itemRight").css({
                left: 76,
                paddingTop: 0,
                width: "176"
                ...
                b.touchmove || b.scrollingIsOn && b.isMobile.any() || (b.preloader && b.preloader.stop().animate({
                    ...
                    e(this).show()
                }), b.videoid = i.id, b.VIDEO.setPlaylistItem(b.videoid), b.VIDEO.resetPlayer(), b.VIDEO.resetPlayerAD(), b.VIDEO.resizeAll(), V(), b.VIDEO.playVideoById(b.videoid), b.youtubeSTARTED = !1, v && "AD 5 sec + Pieces After Effects project" != b.options.videos[0].title && "Pieces After Effects project" != b.options.videos[0].title && "AD 5 sec + Space Odyssey After Effects Project" != b.options.videos[0].title && "AD 5 sec Swimwear Spring Summer" != b.options.videos[0].title && "i Create" != b.options.videos[0].title && "Swimwear Spring Summer" != b.options.videos[0].title && "PLxKkYph0URW7m7cMaHq9Df1sjNF38huut" != b.options.youtubePlaylistID && "Google drive video example" != b.options.videos[0].title && "Dropbox video example" != b.options.videos[0].title && "Livestream HLS m3u8 video example" != b.options.videos[0].title && "Openload video example" != b.options.videos[0].title && "Youtube 360 VR video" != b.options.videos[0].title && "Subtitles video example" != b.options.videos[0].title && "Live YouTube" != b.options.videos[0].title && "HTML5 Live video thumbnails" != b.options.videos[0].title && "HTML5 vtt video thumbnails" != b.options.videos[0].title && b.VIDEO.pw())
            })
    ...
    switch (b.options.playlist) {
        case "Right playlist":
            "Yes" == t.loadRandomVideoOnStart ? (e(b.item_array[b.rand]).removeClass("player_itemUnselected player_" + this.options.instanceTheme).addClass("player_itemSelected player_" + this.options.instanceTheme), b.item_array[b.rand].find(".player_thumbnail_image").removeClass("player_thumbnail_image").addClass("player_thumbnail_imageSelected"), b.VIDEO.playedVideos.push(b.rand)) : (e(b.item_array[b.videoid]).removeClass("player_itemUnselected player_" + this.options.instanceTheme).addClass("player_itemSelected player_" + this.options.instanceTheme), b.item_array[b.videoid].find(".player_thumbnail_image").removeClass("player_thumbnail_image").addClass("player_thumbnail_imageSelected"), b.VIDEO.playedVideos.push(b.videoid));
            break;
        case "Bottom playlist":
            "Yes" == t.loadRandomVideoOnStart ? (e(b.item_array[b.rand]).removeClass("player_itemUnselected_bottom player_" + this.options.instanceTheme).addClass("player_itemSelected_bottom player_" + this.options.instanceTheme), b.item_array[b.rand].find(".player_thumbnail_image").removeClass("player_thumbnail_image").addClass("player_thumbnail_imageSelected"), b.VIDEO.playedVideos.push(b.rand)) : (e(b.item_array[b.videoid]).removeClass("player_itemUnselected_bottom player_" + this.options.instanceTheme).addClass("player_itemSelected_bottom player_" + this.options.instanceTheme), b.item_array[b.videoid].find(".player_thumbnail_image").removeClass("player_thumbnail_image").addClass("player_thumbnail_imageSelected"), b.VIDEO.playedVideos.push(b.videoid))
    }
        ...
        if (b.VIDEO.imageWrapper.css({
            ...
            if (this.canPlay = !0, "Yes" == t.loadRandomVideoOnStart) {
                switch (t.HTML5VideoQuality) {
                    case "HD":
                        b.video_path = b.videos_array[b.rand].video_path_mp4HD;
                        break;
                    case "SD":
                        b.video_path = b.videos_array[b.rand].video_path_mp4SD
                }
                b.video_pathAD = b.videos_array[b.rand].preroll_mp4
            } else if ("No" == t.loadRandomVideoOnStart) {
            switch (t.HTML5VideoQuality) {
                case "HD":
                    b.video_path = b.videos_array[b.videoid].video_path_mp4HD;
                    break;
                case "SD":
                    b.video_path = b.videos_array[b.videoid].video_path_mp4SD
            }
        ...
        callbacks: {
            onScrollStart: function() {
                b.isMobile.any() && setTimeout(function() {
                    b.playlistContentOverlay.show(), b.scrollingIsOn = !0
                }, 50)
            },
            onScroll: function() {
                b.isMobile.any() && (b.playlistContentOverlay.hide(), b.scrollingIsOn = !1, b.touchmove = !1)
            },
